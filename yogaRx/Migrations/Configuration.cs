    ...
    internal sealed class Configuration : DbMigrationsConfiguration<yogaRx.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(yogaRx.Models.ApplicationDbContext context)
        {
            ...
            context.Poses.AddOrUpdate(p => p.PoseName,
               ...
               new Pose
               {
                   PoseName = "<b>Extended Puppy Pose</b>",
               ...
               new Pose
               {
                   PoseName = "<b>Seated Forward Fold</b>",
                 ...
                 new Pose
                 {
                     PoseName = "<b>Standing Forward Fold</b>",
                  ...
                  new Pose
                  {
                      PoseName = "<b>Downward Facing Dog</b>",
                  ...
                  new Pose
                  {
                      ...
                      new Pose
                      {
                       ...
                       new Pose
                       {
                           PoseName = "<b>Table Top with Reversed Hands</b>",
